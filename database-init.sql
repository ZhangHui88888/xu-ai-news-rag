...
-- ===========================
-- 数据源表（需要先创建，因为knowledge_entry有外键引用）
-- ===========================
...
SELECT '初始账户信息：' AS info;
SELECT '  管理员 - 用户名: admin, 密码: admin123' AS account;
SELECT '  测试用户 - 用户名: user, 密码: user123' AS account;
