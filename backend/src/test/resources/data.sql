...
-- 插入测试知识库条目
INSERT INTO knowledge_entry (id, title, content, summary, content_type, source_url, source_name, author, published_at, created_by, source_id, created_at, updated_at, deleted) 
...
VALUES (1, 'system.version', '1.0.0', '系统版本号', NOW(), NOW());

INSERT INTO system_config (id, config_key, config_value, description, created_at, updated_at) 
VALUES (2, 'ai.model.llm', 'qwen3:0.6b', 'LLM模型名称', NOW(), NOW());
